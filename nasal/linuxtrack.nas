...
ltr_view_handler.update = func {
	...
	if ((view_name == "Helicopter View") or
	    ...
	    (view_name == "Chase View Without Yaw") or
        (view_name == "FGCamera1") or
        (view_name == "FGCamera2") or
        (view_name == "FGCamera3") or
        (view_name == "FGCamera4") or
        (view_name == "FGCamera5")) {
...
ltr_view_handler.init_settings = func {
	me.enabled   = props.globals.getNode(lt_tree ~ "/enabled", 0);
	me.track_all = props.globals.getNode(lt_tree ~ "/track-all", 0);
